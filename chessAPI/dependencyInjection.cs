        ...
        where TC : struct
{
    protected override void Load(ContainerBuilder builder)
    {
        ...
        builder.Register(c=> new clsTeamRepository(c.Resolve<IMongoCollection<clsTeamEntityModel>>()))
            .InstancePerDependency()
            .As<ITeamRepository>();
        #endregion
        ...
        builder.Register(c => new clsGameBusiness(c.Resolve<IGameRepository>()))
               .InstancePerDependency()
               .As<IGameBusiness>();
        builder.Register(c => new clsTeamBusiness(c.Resolve<ITeamRepository>()))
               .InstancePerDependency()
               .As<ITeamBusiness>();
        #endregion
    }
